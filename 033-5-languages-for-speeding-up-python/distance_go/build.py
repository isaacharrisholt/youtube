# python build stubs for package distance_go
...
mod = Module('_distance_go')
mod.add_include('"distance_go_go.h"')
...
mod.add_function('distance_go_Coord_CTor', retval('int64_t'), [])
mod.add_function('distance_go_Coord_X_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('distance_go_Coord_X_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('distance_go_Coord_Y_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('distance_go_Coord_Y_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('distance_go_CoordList_CTor', retval('int64_t'), [])
mod.add_function('distance_go_CoordList_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('distance_go_CoordList_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('distance_go_CoordList_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('distance_go_CoordList_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('distance_go_CoordList_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
add_checked_function(mod, 'distance_go_CalculateDistance', retval('double'), [param('int64_t', 'coords')])

mod.generate(open('distance_go.c', 'w'))
